...
3. <+4>: Reserva (desplaza) `288 bytes` (0x120) en el stack de `main()` para que el compiladororganiza las variables locales y los argumentos de las funciones que `main()` va a llamar.
